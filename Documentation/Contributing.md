...
- Take a look at the existing [**Issues**](https://github.com/multiverseweb/Dataverse/issues). 
- Fork the Repo & create a branch for any issue that you are working on and commit your work.
- At first raise an issue in which you want to work
- Then after assigning only then work on that issue & make a PR 
- Create a [**Pull Request**](https://github.com/multiverseweb/Dataverse/pulls), which will be promptly reviewed and given suggestions for improvements by the community.
...
1. Navigate to the project's issues section :- [Issues](https://github.com/multiverseweb/Dataverse/issues)
